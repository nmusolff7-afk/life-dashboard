...
Examples:
```
- [Bug] meal logger crashes on tap of save (blocker)
- [UX] dark mode toggle would be nice
- [Feature] export weekly summary as PDF
- [Question] should priority tasks roll over to next day automatically?
```
